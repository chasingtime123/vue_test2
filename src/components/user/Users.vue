<template>
    <div>
        ...
        <el-card>
            ...
            <el-row :gutter="20">
                <el-col :span="8">
                    <el-input v-model="input" placeholder="请输入内容" clearable @clear="getUserList "><!-- v-model="queryInfo.query"-->
                    ...
                    <template slot-scope="scope">
                        <!--修改按钮-->
                            <el-button type="primary" icon="el-icon-edit"
                                       size="mini" @click="showEditDialog()"></el-button><!--@click="showEditDialog(scope.row.id)"-->
                        <!--删除按钮-->
                            <el-button type="danger" icon="el-icon-delete"
                                       size="mini" @click="removeUserByID()"></el-button><!--@click="removeUserByID(scope.row.id)"-->
                        <!--分配角色按钮-->
    ...
    export default {
        data(){
            ...
            var  checkEmail = (rule, value, cb) => {
                const regEmail = /^(a-zA-Z0-9_-)+@(a-zA-Z-0-9_-])+(\.[a-z-A-Z0-9_-])+/
